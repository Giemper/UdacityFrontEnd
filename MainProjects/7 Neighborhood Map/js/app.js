...
var ViewModel = function () {
    ...
    // this.selected reads the selected value of the dropdown filter
    ...
    this.linesChange = function(){
        ...
        if (selected === "all") {
            ...
            vm.points().forEach(function(point){
                if (point.value.includes(selected))
                    vm.list.push(point);
            });
        }

        // This makes sure of displaying the markers on the map.
        vm.pins().forEach(function (pin) {
